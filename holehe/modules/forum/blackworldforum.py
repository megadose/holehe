...
def blackworldforum(email):
    ...
    r=s.get("http://blackworldforum.com/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('http://blackworldforum.com/xmlhttp.php', headers=headers, params=params, data=data)
