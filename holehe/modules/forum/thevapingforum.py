...
def thevapingforum(email):
    ...
    r=s.get("http://www.thevapingforum.com/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('http://www.thevapingforum.com/xmlhttp.php', headers=headers, params=params, data=data)
