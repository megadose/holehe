...
def nextpvr(email):
    ...
    r=s.get("https://forums.nextpvr.com/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://forums.nextpvr.com/xmlhttp.php', headers=headers, params=params, data=data)
