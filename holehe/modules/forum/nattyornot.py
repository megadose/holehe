...
def nattyornot(email):
    ...
    r=s.get("https://nattyornotforum.nattyornot.com/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://nattyornotforum.nattyornot.com/xmlhttp.php', headers=headers, params=params, data=data)
