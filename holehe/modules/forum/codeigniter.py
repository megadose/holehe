...
def codeigniter(email):
    ...
    r=s.get("https://forum.codeigniter.com/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://forum.codeigniter.com/xmlhttp.php', headers=headers, params=params, data=data)
