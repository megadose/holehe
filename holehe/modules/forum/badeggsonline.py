...
def badeggsonline(email):
    ...
    r=s.get("https://www.badeggsonline.com/beo2-forum/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://www.badeggsonline.com/beo2-forum/xmlhttp.php', headers=headers, params=params, data=data)
