...
def treasureclassifieds(email):
    ...
    r=s.get("https://forum.treasureclassifieds.com/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://forum.treasureclassifieds.com/xmlhttp.php', headers=headers, params=params, data=data)
