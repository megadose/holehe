...
def cambridgemt(email):
    ...
    r=s.get("https://discussion.cambridge-mt.com/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://discussion.cambridge-mt.com/xmlhttp.php', headers=headers, params=params, data=data)
