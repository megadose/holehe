...
def blitzortung(email):
    ...
    r=s.get("https://forum.blitzortung.org/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://forum.blitzortung.org/xmlhttp.php', headers=headers, params=params, data=data)
