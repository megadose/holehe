...
def biotechnologyforums(email):
    ...
    r=s.get("https://biotechnologyforums.com/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://biotechnologyforums.com/xmlhttp.php', headers=headers, params=params, data=data)
