...
def ndemiccreations(email):
    ...
    r=s.get("https://forum.ndemiccreations.com/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://forum.ndemiccreations.com/xmlhttp.php', headers=headers, params=params, data=data)
