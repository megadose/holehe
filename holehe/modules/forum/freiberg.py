...
def freiberg(email):
    ...
    r=s.get("https://drachenhort.user.stunet.tu-freiberg.de/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://drachenhort.user.stunet.tu-freiberg.de/xmlhttp.php', headers=headers, params=params, data=data)
