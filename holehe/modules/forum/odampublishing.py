...
def odampublishing(email):
    ...
    r=s.get("https://forum.odampublishing.com/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://forum.odampublishing.com/xmlhttp.php', headers=headers, params=params, data=data)
