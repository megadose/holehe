...
def thecardboard(email):
    ...
    r=s.get("https://thecardboard.org/board/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://thecardboard.org/board/xmlhttp.php', headers=headers, params=params, data=data)
