...
def mybb(email):
    ...
    r=s.get("https://community.mybb.com/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://community.mybb.com/xmlhttp.php', headers=headers, params=params, data=data)
