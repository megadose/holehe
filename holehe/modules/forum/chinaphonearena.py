...
def chinaphonearena(email):
    ...
    r=s.get("https://www.chinaphonearena.com/forum/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://www.chinaphonearena.com/forum/xmlhttp.php', headers=headers, params=params, data=data)
