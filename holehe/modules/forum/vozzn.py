...
async def vozzn(email, client, out):
    name = "vozzn"
    headers = {
        'User-Agent': random.choice(ua["browsers"]["chrome"]),
        'Accept': 'application/json, text/javascript, */*; q=0.01',
        'Accept-Language': 'en,en-US;q=0.5',
        'Referer': 'https://www.voz.vn/member.php',
        'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
        'Origin': 'https://www.voz.vn',
        'DNT': '1',
        'Connection': 'keep-alive',
        'TE': 'Trailers',
    }
    try:
        r = await client.get("https://www.voz.vn/member.php", headers=headers)
    ...
    try:
        ...
        out.append({"name": name,
                    ...
                    "others": None})
        return None
    response = await client.post('https://www.voz.vn/xmlhttp.php', headers=headers, params=params, data=data)
