...
def biosmods(email):
    ...
    r=s.get("https://bios-mods.com/forum/member.php",headers=headers)
    ...
    try:
        ...
        return({"rateLimit": True, "exists": False, "emailrecovery": None, "phoneNumber": None, "others": None})
    response = s.post('https://bios-mods.com/forum/xmlhttp.php', headers=headers, params=params, data=data)
