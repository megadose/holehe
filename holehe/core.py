    ...
    for module in modules:
        if len(module.split(".")) > 3 :
            ...
            if args !=None and args.nopasswordrecovery==True:
                if "adobe" not in str(modu.__dict__[site]) and "mail_ru" not in str(modu.__dict__[site]) and "odnoklassniki" not in str(modu.__dict__[site]) and "apple" not in str(modu.__dict__[site]):
